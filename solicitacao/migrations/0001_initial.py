# Generated by Django 3.0.3 on 2020-04-17 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linha_pesquisa', solicitacao.fields.NullFK(blank=True, help_text='Obrigatório para alunos de Mestrado e Doutourado. Caso não saiba, escreva "A definir".', null=True, on_delete=django.db.models.deletion.CASCADE, to='dominio_suap.LinhaPesquisa', verbose_name='Linha de pesquisa')),
                ...
                ('superdotacao', solicitacao.fields.NullFK(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dominio_suap.TipoSuperdotacao', verbose_name='Superdotação')),
                ...
                ('tipo_necessidade_especial', solicitacao.fields.NullFK(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dominio_suap.TipoNecessidadeEspecial', verbose_name='Deficiência')),
                ...
                ('tipo_transtorno', solicitacao.fields.NullFK(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dominio_suap.TipoTranstorno', verbose_name='Transtorno')),
